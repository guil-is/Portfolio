...
// ---------------------------------------------------------------------
// /for/spa/proposal — the original WinWin 2026 proposal sent to Lara
// Sibbing (Sustainable Public Affairs), kept live as its own document.
// The Service Agreement incorporates it by reference, so it must stay
// accessible and should be treated as frozen: don't edit the terms here
// after signing.
//
// Shares the /for/spa workspace password (storageKey "for-spa-unlocked"),
// so opening it from the workspace needs no second unlock.
//
...
export const metadata = {
  title: "WinWin 2026 proposal | Private",
...
export default function SpaProposalPage() {
  return (
    <>
      <div className="no-print fixed left-4 top-4 z-50">
        <Link
          href="/for/spa"
          className="inline-flex items-center gap-1.5 rounded-full border border-rule bg-bg/80 px-3 py-1.5 font-caption text-[11px] font-semibold uppercase tracking-[1.5px] text-muted backdrop-blur transition-colors hover:border-ink hover:text-ink"
        >
