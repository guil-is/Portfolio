...
export const invoiceLedger: LedgerEntry[] = [
  {
    // Renumbered from INV-26020: that number went to the WinWin phase 3
    // invoice issued the same day in a parallel session.
    number: "INV-26021",
    client: "Studio Huit",
    clientSlug: "huit",
    issuedAt: "2026-09-02",
  ...
  },
  {
    ...
    total: 2000,
    currency: "EUR",
    note: "E2C Cookbook design, flat fee (reverse charge). Reissued same day at Primavera's request: BlockchainGov named, CERSA added to the bill-to. Card payment via Stripe 28 July, settled the next day (confirmed 27 Aug). Stripe fee absorbed.",
  },
  {
    number: "INV-26016",
    client: "Sustainable Public Affairs (WinWin 2026)",
