...
export const pastProjects: PastProject[] = [
  ...
  },
  {
    ...
    client: "Gaia Gives",
    services:
      "Brand Identity, Web Design, UI/UX, Product Design, Marketing",
    summary:
    ...
    gridImage: "/projects/gaia-gives.jpg",
    link: "https://gaiagives.webflow.io/",
    featured: true,
    projectDetails:
      "<p>The bet was simple. On-chain accountability should not require a wallet, a whitepaper, or a crypto vocabulary to feel useful. We built a Web 2.5 platform that spoke to mainstream donors while keeping the trust guarantees of the underlying tech.</p><h3>My role</h3><p>I led design across brand and product, working directly with founder and CMO Matt Gillespie on strategy and positioning, and with the CTO on rapid product iteration. I owned the visual identity, the logo, and the full UI/UX of the web app, from wireframe to pixel-perfect prototype.</p><h3>What I shipped</h3><ul><li>Brand strategy, positioning, color system, typography</li><li>Logo and core visual identity</li><li>Full web app design from wireframe to prototype</li><li>Product roadmap in collaboration with the CTO</li><li>Marketing site, social content, and pitch materials</li></ul><h3>Outcomes</h3><ul><li>180k USD raised in pre-seed after more than 40 investor pitches</li><li>14 globally recognized nonprofits onboarded as launch partners</li><li>Over 100k USD in donations generated through the platform</li></ul><h3>Why it mattered</h3><p>Most crypto-for-good projects get stuck speaking to the already-converted. Gaia Gives was a test of whether Web3 infrastructure could disappear into a donor flow that felt like any other giving platform, with transparency as a quiet feature rather than a sales pitch.</p><h3>Tools</h3><p>Figma, Sketch, Webflow, Jira, Pitch.</p>",
  },
  {
    name: "Chinwags",
    slug: "chinwags",
  ...
  {
    name: "Burger King Rebrand Sizzle",
