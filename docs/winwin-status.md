...
- Aftermovie (separate from the design fee): proposal at guil.is/for/spa-aftermovie, 10 Sep. v2 11 Sep: same deliverables in both tiers (2-min aftermovie 16:9 + vertical, 48-hour teaser, every stage session recorded, no cap). Professional 4,750 EUR (Guil 800 + assistant 500, rental 450, aftermovie/teaser/vertical edit 2,000, talks edit 800, travel 200) or Lightweight 3,800 (solo 800, same edit lines, travel 200). Same deliverables; the difference is image quality (real depth of field, low light, sound). Run-of-show check at the venue the morning before (2 Nov). Half on go-ahead, half on delivery. Terms: SPA owns the films (web + social), portfolio use only with written OK, filming notice/opt-out on WinWin's side, cabinet approval for protected guests, day stands if protocol limits filming. Filming plan for the cabinet only after they sign. Not yet sent / not yet accepted.
